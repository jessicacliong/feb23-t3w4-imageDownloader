// Synchronous library for doing file IO (Input and Output)
...
// Streaming data (keeps ongoing download until we command it to stop), safer than traidional file saving/downloading/etc
...
async function getPokemonPictureUrl(targetId = getRandomPokemonId()){
  ...
  // return imageUrl
  // not memory efficient, not optimized. It makes unnecessary variables
